...
if ($user_type === 'locatario') {
    ...
    // Obtener el locatario_id desde la tabla de usuarios
    ...
    try {
        // Obtener inmuebles del locatario usando locatario_id correcto
        ...
        foreach ($inmuebles as &$inmueble) {
            ...
            $stmt = $condominioConn->prepare("
                ...
                LIMIT 12
            ");
            $stmt->execute([$inmueble['id'], $locatario_id, $anioActual]);
